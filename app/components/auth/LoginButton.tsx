	...
	if (activeWallet && !profile) {
		...
		return (
			<div className="flex flex-row gap-3">
				<Link
					href="/CreateProfile"
					className="min-w-min flex focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-lg px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
				...
				<button
					...
					className="min-w-min flex py-2.5 px-5 mr-2 mb-2 text-lg font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
					// disabled={isDisconnectLoading || isLogoutPending}
				>
					Disconnect wallet
				</button>
	...
	return (
		<div className="flex min-w-full">
			...
			<WhenLoggedOut>
				<button
					type="button"
					className="min-w-min flex text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-lg px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
					onClick={
						isConnected
							? (e) => {
									onLoginClick(e)
