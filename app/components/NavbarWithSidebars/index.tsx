...
export function NavbarWithSidebars({
	...
	return (
		<div className="flex flex-col">
			<nav className="sticky top-0 z-50 w-full bg-white dark:bg-gray-800">
				<div className="p-3 lg:p-6">
					<div className="flex items-center justify-between">
						<div className="flex items-center justify-start">
							...
							<Link href="/" className="flex ml-2 md:mr-24 gap-3">
								<svg
			...
			<div className="flex flex-col max-w-max gap-6 mx-4 lg:mx-96">
				...
				>
					<div className="h-full px-4 pb-4 overflow-y-auto bg-white dark:bg-gray-800 justify-between flex flex-col items-center">
						<ul className="space-y-2 font-medium gap-2 flex flex-col">
							{[
								"Contacts",
								"Discovery",
								"Latest",
				...
				>
					<div className="h-full px-4 pb-4 overflow-y-auto bg-white items-center dark:bg-gray-800 justify-between flex flex-col">
						<form className="flex flex-col items-center gap-6">
							...
							<a className="text-xl">Suggested</a>
