	...
	return (
		...
		>
			<div className="flex flex-row justify-between">
				<div
					role="tooltip"
					className="w-[50%] z-10 inline-block w-64 text-sm text-gray-500  bg-white rounded-lg  dark:text-gray-400 dark:bg-gray-800"
				>
					<div className="p-3">
				...
				<figure className="flex flex-col w-[50%]">
					...
					/>
					<figcaption className="mt-2 text-3xl text-black dark:text-gray-400">
						Jese Leos
					</figcaption>
